...
printf "#1) Submit proposal to delete the ulunax Alliance...\n\n"
allianced tx gov submit-legacy-proposal delete-alliance ulunax --from=demowallet1 --home ./data/alliance --keyring-backend=test --broadcast-mode=block --gas 1000000 -y > /dev/null 2>&1
