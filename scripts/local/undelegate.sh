...
printf "#1) Undelegate 10000000000$COIN_DENOM thru x/alliance $COIN_DENOM...\n\n"
allianced tx alliance undelegate $VAL_ADDR 10000000000$COIN_DENOM --from=node0 --home ../../.testnets/node0/allianced --keyring-backend=test --broadcast-mode=block --gas 1000000 --chain-id=alliance-testnet-1 -y
