...
$BINARY add-genesis-account $VAL2_ADDR 1000000000000stake --home $CHAIN_DIR/$CHAINID_2
$BINARY add-genesis-account $WALLET1_ADDR 1000000000000stake --home $CHAIN_DIR/$CHAINID_1
$BINARY add-genesis-account $WALLET2_ADDR 1000000000000stake --home $CHAIN_DIR/$CHAINID_2
$BINARY add-genesis-account $RLY1_ADDR 1000000000000stake --home $CHAIN_DIR/$CHAINID_1
$BINARY add-genesis-account $RLY2_ADDR 1000000000000stake --home $CHAIN_DIR/$CHAINID_2

echo "Creating and collecting gentx..."
$BINARY gentx val1 6500000000stake --home $CHAIN_DIR/$CHAINID_1 --chain-id $CHAINID_1 --keyring-backend test
$BINARY gentx val2 6500000000stake --home $CHAIN_DIR/$CHAINID_2 --chain-id $CHAINID_2 --keyring-backend test
...
sed -i -e 's/"reward_delay_time": "604800s"/"reward_delay_time": "10s"/g' $CHAIN_DIR/$CHAINID_2/config/genesis.json
