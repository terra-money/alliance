...
Example:
	allianced testnet init-files --v 4 --output-dir ./.testnets --starting-ip-address 192.168.5.20
	`,
	...
	cmd.Flags().String(flagNodeDaemonHome, "allianced", "Home directory of the node's daemon configuration")
...
Example:
	allianced testnet --v 4 --output-dir ./.testnets
	`,
		RunE: func(cmd *cobra.Command, _ []string) error {
			args := startArgs{}
			args.outputDir, _ = cmd.Flags().GetString(flagOutputDir)
