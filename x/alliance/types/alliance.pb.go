...
type AllianceAsset struct {
	...
	RewardWeightRange RewardWeightRange `protobuf:"bytes,3,opt,name=reward_weight_range,json=rewardWeightRange,proto3" json:"reward_weight_range"`
	...
	TotalTokens          github_com_cosmos_cosmos_sdk_types.Int `protobuf:"bytes,5,opt,name=total_tokens,json=totalTokens,proto3,customtype=github.com/cosmos/cosmos-sdk/types.Int" json:"total_tokens"`
	TotalValidatorShares github_com_cosmos_cosmos_sdk_types.Dec `protobuf:"bytes,6,opt,name=total_validator_shares,json=totalValidatorShares,proto3,customtype=github.com/cosmos/cosmos-sdk/types.Dec" json:"total_validator_shares"`
	RewardStartTime      time.Time                              `protobuf:"bytes,7,opt,name=reward_start_time,json=rewardStartTime,proto3,stdtime" json:"reward_start_time"`
	RewardChangeRate     github_com_cosmos_cosmos_sdk_types.Dec `protobuf:"bytes,8,opt,name=reward_change_rate,json=rewardChangeRate,proto3,customtype=github.com/cosmos/cosmos-sdk/types.Dec" json:"reward_change_rate"`
	RewardChangeInterval time.Duration                          `protobuf:"bytes,9,opt,name=reward_change_interval,json=rewardChangeInterval,proto3,stdduration" json:"reward_change_interval"`
	LastRewardChangeTime time.Time                              `protobuf:"bytes,10,opt,name=last_reward_change_time,json=lastRewardChangeTime,proto3,stdtime" json:"last_reward_change_time"`
}
...
var fileDescriptor_f7dbf17f28cd0f90 = []byte{
	...
	,
}
